...
def getxh():
    ...
    xh_male_1_10=list(range(1,10))
    xh_male_1_11=list(range(10,25))
    xh_male_1_10=['1311120200'+str(x) for x in xh_male_1_10]
    xh_male_1_11=['131112020'+str(x) for x in xh_male_1_11]
    xh_female_1=list(range(24,37))
    xh_female_1=['131212020'+str(x) for x in xh_female_1]
    xh_1=xh_male_1_10+xh_male_1_11+xh_female_1
    
    xh_male_2=list(range(49,55))
    xh_male_2=['131112020'+str(x) for x in xh_male_2]
    xh_female_2=list(range(60,73))
    xh_female_2=['131212020'+str(x) for x in xh_female_2]
    xh_2=xh_male_2+xh_female_2
